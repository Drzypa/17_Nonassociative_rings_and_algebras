...
\usepackage{pmmeta}
\pmcanonicalname{Nilradical1}
\pmcreated{2013-03-22 13:51:22}
\pmmodified{2013-03-22 13:51:22}
\pmowner{bwebste}{988}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
Let $\g$ be a Lie algebra.  Then the nilradical $\mathfrak n$ of $\g$ is defined to be the intersection of the kernels of all the irreducible representations of $\g$.  Equivalently, $\n=[\g,\g]\cap\mathrm{rad}\,\g$, the intersection of the derived ideal and radical of $\g$.
%%%%%
%%%%%
\end{document}
