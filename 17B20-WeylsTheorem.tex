...
\usepackage{pmmeta}
\pmcanonicalname{WeylsTheorem}
\pmcreated{2013-03-22 13:21:24}
\pmmodified{2013-03-22 13:21:24}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{Weyl's theorem}
\pmrecord{5}{33877}
\pmprivacy{1}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
Let $\fr g$ be a finite dimensional semi-simple Lie algebra.  Then any finite dimensional representation of $\fr g$ is completely reducible.
%%%%%
%%%%%
\end{document}
