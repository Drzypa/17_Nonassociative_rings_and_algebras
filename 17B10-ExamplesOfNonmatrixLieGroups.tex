...
\usepackage{pmmeta}
\pmcanonicalname{ExamplesOfNonmatrixLieGroups}
\pmcreated{2013-03-22 13:20:48}
\pmmodified{2013-03-22 13:20:48}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{examples of non-matrix Lie groups}
\pmrecord{6}{33864}
\pmprivacy{1}
...
$$H=\left\{\begin{pmatrix} 1 & a & b\\0&1&c\\ 0 &0 &1\end{pmatrix}\mid a,b,c\in\R\right\},$$

and $\Gamma$ the discrete subgroup 

$$\Gamma=\left\{\begin{pmatrix} 1 & 0 & n\\0&1&0\\ 0 &0 &1\end{pmatrix}\mid n\in\Z\right\}.$$

The subgroup $\Gamma$ is central, and thus normal.  The Lie group $H/\Gamma$ has no faithful finite dimensional representations over $\R$ or $\C$.

Another example is the universal cover of $\SL 2\R$.  $\SL 2\R$ is homotopy equivalent to a circle, and thus $\pi(\SL 2\R)\cong\Z$, and thus has an infinite-sheeted cover.  Any real or complex representation of this group factors through the projection map to $\SL 2\R$.
%%%%%
%%%%%
\end{document}
