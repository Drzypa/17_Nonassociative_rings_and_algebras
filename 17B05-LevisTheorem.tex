...
\usepackage{pmmeta}
\pmcanonicalname{LevisTheorem}
\pmcreated{2013-03-22 13:51:15}
\pmmodified{2013-03-22 13:51:15}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{Levi's theorem}
\pmrecord{5}{34592}
\pmprivacy{1}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
Let $\mathfrak{g}$ be a complex Lie algebra, $\mathfrak r$ its radical.  Then the extension $0\to\mathfrak {r\to g\to g/r}\to 0$ is split, i.e., there exists a subalgebra $\mathfrak h$ of $\mathfrak g$ mapping isomorphically to $\mathfrak {g/r}$ under the natural projection.
%%%%%
%%%%%
\end{document}
