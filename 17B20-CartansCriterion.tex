...
\usepackage{pmmeta}
\pmcanonicalname{CartansCriterion}
\pmcreated{2013-03-22 13:15:50}
\pmmodified{2013-03-22 13:15:50}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{Cartan's criterion}
\pmrecord{5}{33744}
\pmprivacy{1}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
A Lie algebra $\fr g$ is semi-simple if and only if its Killing form $B_{\fr g}$ is nondegenerate.
%%%%%
%%%%%
\end{document}
