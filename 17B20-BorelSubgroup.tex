...
\usepackage{pmmeta}
\pmcanonicalname{BorelSubgroup}
\pmcreated{2013-03-22 13:27:58}
\pmmodified{2013-03-22 13:27:58}
\pmowner{CWoo}{3771}
\pmmodifier{CWoo}{3771}
\pmtitle{Borel subgroup}
\pmrecord{6}{34035}
\pmprivacy{1}
\pmauthor{CWoo}{3771}
\pmtype{Definition}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
Let $G=\GL n\C$, the group of all automorphisms of the $n$-dimensional vector space over the field of complex numbers $\mathbb{C}$, and $H\le G$ a subgroup of $G$.  The \emph{standard Borel subgroup} of $H$ is the subgroup of $H$ consisting of all upper triangular matrices (in $H$).  A \emph{Borel subgroup} of $H$ is a conjugate (in $H$) of the standard Borel subgroup of $H$.

The notion of a Borel subgroup can be generalized.  Let $G$ be a complex semi-simple Lie group.  Then any maximal solvable subgroup $B\leq G$ is called a Borel subgroup.  All Borel subgroups of a given group are 
