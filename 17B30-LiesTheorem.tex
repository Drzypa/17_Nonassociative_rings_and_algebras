...
\usepackage{pmmeta}
\pmcanonicalname{LiesTheorem}
\pmcreated{2013-03-22 13:20:40}
\pmmodified{2013-03-22 13:20:40}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{Lie's theorem}
\pmrecord{6}{33860}
\pmprivacy{1}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
Let $\fr g$ be a finite dimensional complex solvable Lie algebra, and $V$ a repesentation of $\fr g$.  Then there exists an element of $V$ which is a simultaneous eigenvector for all elements of $\fr g$.

Applying this result inductively, we find that there is a basis of $V$ with respect to which all elements of $\fr g$ are upper triangular.
%%%%%
%%%%%
\end{document}
