...
\usepackage{pmmeta}
\pmcanonicalname{CartanSubalgebra}
\pmcreated{2013-03-22 13:20:09}
\pmmodified{2013-03-22 13:20:09}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{Cartan subalgebra}
\pmrecord{7}{33849}
\pmprivacy{1}
...
\pmdefines{rank of a Lie algebra}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
Let $\fr g$ be a Lie algebra.  Then a {\em Cartan subalgebra} is a maximal subalgebra of $\fr g$ which is {\em self-normalizing}, that is, if $[g,h]\in\fr h$ for all $h\in\fr h$, then $g\in\fr h$ as well.  Any Cartan subalgebra $\fr h$ is nilpotent, and if $\fr g$ is semi-simple, it is abelian.  All Cartan subalgebras of a Lie algebra are conjugate by the adjoint action of any Lie group with algebra $\fr g$.

The dimension of $\fr h$ is called the {\em rank} of $\fr g$.
%%%%%
%%%%%
\end{document}
