...
\usepackage{pmmeta}
\pmcanonicalname{RealForm}
\pmcreated{2013-03-22 13:23:34}
\pmmodified{2013-03-22 13:23:34}
\pmowner{bwebste}{988}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
Let $G$ be a complex Lie group.  A real Lie group $K$ called a {\em real form} of $G$ if $\fr g\cong\C\otimes_{\R}\fr k$, where $\fr g$ and $\fr k$ are the Lie algebras of $G$ and $K$, respectively.
%%%%%
%%%%%
\end{document}
